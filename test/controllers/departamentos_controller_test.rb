...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { descripcion: @departamento.descripcion, foto: @departamento.foto, nombre: @departamento.nombre } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { descripcion: @departamento.descripcion, foto: @departamento.foto, nombre: @departamento.nombre } }
