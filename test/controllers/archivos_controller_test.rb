...
class ArchivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archivo" do
    assert_difference('Archivo.count') do
      post archivos_url, params: { archivo: { fecha: @archivo.fecha, fuente: @archivo.fuente, titulo: @archivo.titulo } }
    end
  ...
  test "should update archivo" do
    patch archivo_url(@archivo), params: { archivo: { fecha: @archivo.fecha, fuente: @archivo.fuente, titulo: @archivo.titulo } }
