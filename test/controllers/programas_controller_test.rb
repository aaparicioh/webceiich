...
class ProgramasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post programas_url, params: { programa: { descripcion: @programa.descripcion, foto: @programa.foto, nombre: @programa.nombre } }
    end
  ...
  test "should update programa" do
    patch programa_url(@programa), params: { programa: { descripcion: @programa.descripcion, foto: @programa.foto, nombre: @programa.nombre } }
