...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post documentos_url, params: { documento: { anio: @documento.anio, nombre: @documento.nombre, tipo: @documento.tipo } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { anio: @documento.anio, nombre: @documento.nombre, tipo: @documento.tipo } }
