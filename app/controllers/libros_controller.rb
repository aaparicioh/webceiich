class LibrosController < ApplicationController
  ...
  private
    ...
    def libro_params
      params.require(:libro).permit(:clave, :autor, :coordinador, :coleccion_id, :edicion, :anio, :paginas, :isbn, :descriptores, :precio, :sinopsis, :fecha_publicacion, :titulo, :img, :contenido, :imagen,:url, :search, :tematica_id)
    end
end
